...
interface CommandsRegistry {
  register(name: string, callable: (...params: any[]) => void): NovaDisposable;
  register<T>(
    name: string,
...
declare class CompositeDisposable extends NovaDisposable {
  constructor();

  add(object: NovaDisposable): void;
  remove(object: NovaDisposable): void;
  delete(object: NovaDisposable): void;
  clear(): void;
}
...
declare class NovaDisposable {
  constructor();

  static isDisposable(x: any): x is NovaDisposable;
  dispose(): void;
}

/// https://docs.nova.app/api-reference/emitter/

declare class Emitter extends NovaDisposable {
  constructor();
...
interface FileSystemWatcher extends NovaDisposable {
...
declare class Process {
  ...
  onStdout(callback: (line: string) => void): NovaDisposable;
  onStderr(callback: (line: string) => void): NovaDisposable;
  onDidExit(callback: (status: number) => void): NovaDisposable;
  start(): void;
...
declare class TextEditor {
  ...
  getTextInRange(range: Range): string;
  getLineRangeForRange(range: Range): Range;
  onDidChange(callback: (textEditor: TextEditor) => void): NovaDisposable;
  onDidStopChanging(callback: (textEditor: TextEditor) => void): NovaDisposable;
  onWillSave(
    callback: (textEditor: TextEditor) => void | Promise<void>
  ): NovaDisposable;
  onDidSave(callback: (textEditor: TextEditor) => void): NovaDisposable;
  onDidChangeSelection(
    callback: (textEditor: TextEditor) => void
  ): NovaDisposable;
  onDidDestroy(callback: (textEditor: TextEditor) => void): NovaDisposable;
...
declare class TreeView<E> extends NovaDisposable {
  constructor(
    identifier: string,
  ...
  onDidChangeSelection(
    callback: (selectedElements: E[]) => void
  ): NovaDisposable;
  onDidChangeVisibility(callback: () => void): NovaDisposable;
  onDidExpandElement(callback: (element: E) => void): NovaDisposable;
  onDidCollapseElement(callback: (element: E) => void): NovaDisposable;
...
interface Workspace {
  ...
  onDidAddTextEditor(callback: (editor: TextEditor) => void): NovaDisposable;
  onDidChangePath(callback: (newPath: TextEditor) => void): NovaDisposable;
